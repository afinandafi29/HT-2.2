...
let brand = {
    app: {
        language: 'en',
        name: 'Happytalk',
        title: 'Happytalk<br />Free browser based Real-time video calls.<br />Simple, Secure, Fast.',
        description:
    ...
    site: {
        shortcutIcon: '../images/happytalk.png',
        appleTouchIcon: '../images/happytalk.png',
        landingTitle: 'Happytalk a Free Secure Video Calls, Chat & Screen Sharing.',
        newCallTitle: 'Happytalk a Free Secure Video Calls, Chat & Screen Sharing.',
        newCallRoomTitle: 'Pick name. <br />Share URL. <br />Start conference.',
        newCallRoomDescription:
            "Each room has its disposable URL. Just pick a room name and share your custom URL. It's that easy.",
        loginTitle: 'Happytalk - Host Protected login required.',
        clientTitle: 'Happytalk WebRTC Video call, Chat Room & Screen Sharing.',
        privacyPolicyTitle: 'Happytalk - privacy and policy.',
        stunTurnTitle: 'Test Stun/Turn Servers.',
        notFoundTitle: 'Happytalk - 404 Page not found.',
    },
    html: {
        topSponsors: true,
        features: true,
    ...
    about: {
        imageUrl: '../images/happytalk.png',
        title: 'WebRTC P2P v1.7.16',
        html: `
            <br /><br /><br />
            <hr />
            <span>&copy; 2025 Happytalk P2P, all rights reserved</span>
            <hr />
        `,
    },
    widget: {
        ...
        supportWidget: {
            ...
            customMessages: {
                ...
                poweredBy: 'Powered by Happytalk',
            },
        },
    },
    //...
