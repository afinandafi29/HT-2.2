...
function setTheme() {
    ...
    switch (theme) {
        case 'dark':
            // dark theme
            swBg = '#000000';
            setSP('--body-bg', '#000000');
            setSP('--msger-bg', '#000000');
            setSP('--msger-private-bg', '#000000');
            setSP('--wb-bg', '#000000');
...
function showAbout() {
    ...
    Swal.fire({
        background: swBg,
        position: 'center',
        title: brand.about?.title && brand.about.title.trim() !== '' ? brand.about.title : 'WebRTC P2P v1.7.16',
